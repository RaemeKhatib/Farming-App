...
CREATE TABLE harvest (
  ...
  date_packing VARCHAR(255) NOT NULL, -- date when bin/tote is packaged into product units
  date_shipping VARCHAR(255) NOT NULL, -- date when product unit is shipped from farm
  product_unit_packed INTEGER NOT NULL, -- number of product units (i.e. packed from the tote by farm worker)
